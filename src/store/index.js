...
//     console.log('Reducer Running', action)
    switch (action.type) {
        ...
        case 'FAILD_LOGIN':
                return {...state, showspinner: false, isauthenticated: false, loginMessage: "Emri i përdoruesit ose fjalëkalimin i gabuar!"}

        case 'SUCCESS_CHECK':
                return {...state, showspinner: false, isauthenticated: true, isAdmin: true}
        case 'START_CHECK':
                return {...state, showspinner: true}
        case 'FAILD_CHECK_401':
                return {...state, showspinner: false, isauthenticated: false, isAdmin: false, errorStatus: action.payload.error.response.status}
        case 'FAILD_CHECK_403':
                return {...state, showspinner: false, isauthenticated: true, isAdmin: false, errorStatus: action.payload.error.response.status}
        ...
        case 'FAILD_UPDATE_PRICE':
                return {...state, showspinner: false, error: action.payload.error, showError:true}
        ...
        case 'SUCCESS_GET_GAME':
                return {...state, showspinner: false, gameIsReady: true, currentGameID:action.payload.id, currentGametitulli: action.payload.titulli, currentGamendeshja: action.payload.ndeshja, currentGamedata: action.payload.data, currentGameora: action.payload.ora, llojetNdeshjet: action.payload.llojetNdeshjet}
        ...
        case 'SUCCESS_SAVE_GAME':
                return {...state, showspinner: false, gameIsReady: true, currentGameID:action.payload.id, currentGametitulli: action.payload.titulli, currentGamendeshja: action.payload.ndeshja, currentGamedata: action.payload.data, currentGameora: action.payload.ora}
        ...
        case 'SUCCESS_ALL_GAMES':
                ...
                return {...state, showspinner: false, allGames: action.payload.allGames, currentGameSales: action.payload.shitjaJson}
        ...
        case 'SUCCESS_NEW_GAME':
                return {...state, showspinner: false, currentGametitulli: "", currentGamendeshja: "", currentGamedata: "", currentGameora: ""}
        ...
        case 'SUCCESS_TAKENSITS':
                return {...state, showspinner: false, updateTakenSits: false, takenSits: action.payload}
        ...
        case 'CURRENT_GAME_ONCHANGE':
                return {...state, [action.payload.target.id]: action.payload.target.value}
