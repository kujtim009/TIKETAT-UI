        ...
        <div className={classes.left}>
          <div className={classes.header}>
            ...
            <div className={classes.topInfoBlock}>
              ...
              <span className={classes.titulliEng}>Price</span>
              <br className={classes.br} />
            ...
            <div className={classes.topInfoBlock}>
              ...
              <br className={classes.br} />
              <span className={classes.titulliEng}>Date</span>
              <br className={classes.br} />
            ...
            <div className={classes.topInfoBlock}>
              ...
              <br className={classes.br} />
              <span className={classes.titulliEng}>Time</span>
              <br className={classes.br} />
              <span className={classes.titulliInfo}>{this.props.ora}</span>
            </div>
            <div className={classes.topInfoBlock}>
              <span className={classes.titulliShqip}>Vendi</span>
              <br />
              <span className={classes.titulliEng}>Place</span>
              <br />
              <span className={classes.titulliInfo}>Mizahir Isma</span>
            </div>
            <div className={classes.topInfoBlock}>
              <span className={classes.titulliShqip}>Dy. hapen</span>
              <br />
              <span className={classes.titulliEng}>Gate opens</span>
              <br />

              <span className={classes.titulliInfo}>
                {this.state.gateOpens}
              </span>
            </div>
            <div className={classes.topInfoBlock}>
              <span className={classes.titulliShqip}>Nr.i biletes</span>
              <br />
              <span className={classes.titulliEng}>No. of ticket</span>
              <br />
              <span className={classes.titulliInfo}>{this.props.numri}</span>
              <br />
            </div>
          </div>
          ...
          <div className={classes.footer}>
            <div className={classes.bottomInfoBlock}>
              ...
              <br className={classes.br} />
              <span className={classes.titulliEng}>Gate</span>
              <br className={classes.br} />
              <hr />
              <span className={classes.titulliInfoBottom}>
                {this.props.hyrja}
              </span>
            </div>
            <div className={classes.bottomInfoBlock}>
              ...
              <br className={classes.br} />
              <span className={classes.titulliEng}>Block</span>
              <br className={classes.br} />
              <hr />
              <span className={classes.titulliInfoBottom}>
                {this.props.regioni}
            ...
            <div className={classes.bottomInfoBlock}>
              ...
              <br className={classes.br} />
              <span className={classes.titulliEng}>Row</span>
              <br className={classes.br} />
              <hr />
              <span className={classes.titulliInfoBottom}>
                {this.props.reshti}
            ...
            <div className={classes.bottomInfoBlock}>
              ...
              <br className={classes.br} />
              <span className={classes.titulliEng}>Seat</span>
              <br className={classes.br} />
              <hr />
